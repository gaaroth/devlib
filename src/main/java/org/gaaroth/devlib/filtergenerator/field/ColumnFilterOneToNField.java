...
public abstract class ColumnFilterOneToNField<T> extends HorizontalLayout {
	
	public ColumnFilterOneToNField(final FilterGenerator filterGenerator, final String propertyId, final String caption, Class<T> clazz) {
		this(filterGenerator, propertyId, caption, clazz, null, null);
	}
	
	public ColumnFilterOneToNField(final FilterGenerator filterGenerator, final String propertyId, final String caption,
